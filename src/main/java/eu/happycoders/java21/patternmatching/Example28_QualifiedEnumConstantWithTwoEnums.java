...
public class Example28_QualifiedEnumConstantWithTwoEnums {
  ...
  public static void main(String[] args) {
    ...
    flyln(VerticalDirection.UP);
    flyln(VerticalDirection.DOWN);
  }
  ...
  static void fly(Object o) {
    switch (o) {
      ...
      case VerticalDirection.UP -> System.out.print("Gaining altitude");
      case VerticalDirection.DOWN -> System.out.print("Losing altitude");
      default -> {}
    }
  }
}
